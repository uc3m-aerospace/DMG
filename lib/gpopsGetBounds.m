...
for iphase=1:numphases
    ...
    % -------------------------------------------------------------------
    state_matrix_min = zeros(nodes(iphase)+2,sizes(iphase,1));
    state_matrix_max = zeros(nodes(iphase)+2,sizes(iphase,1));
    if ~isequal(sizes(iphase,1),0)
        ...
        state_matrix_min(2:nodes(iphase)+1,:) = repmat(stateMin,1,nodes(iphase)).';
        state_matrix_min(nodes(iphase)+2,:) = statefMin;
        state_matrix_max(1,:) = state0Max;
        state_matrix_max(2:nodes(iphase)+1,:) = repmat(stateMax,1,nodes(iphase)).';
        state_matrix_max(nodes(iphase)+2,:) = statefMax;
        % -------------------------------------------------------------------
