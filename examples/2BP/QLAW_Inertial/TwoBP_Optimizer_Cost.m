...
Mayer    = sol.time(end)*setup.tc/(3600*24)*100; %zeros(size(t0)) %Mayer siempre intenta minimizar. Para maximizar cambiale el signo %Esto es para decirle que quieres maximizar el elemnto final
%Mayer = -xf(5);
