...
MJD_day = floor(MJD);
MJD_seconds = (MJD-MJD_day)*3600*24;
                
%jdtdb = tdbjuliandate(MJD)
  
A = [MJD_day,MJD_seconds,x*setup.lc/1000,y*setup.lc/1000,z*setup.lc/1000];
    ...
    for jj = 1:numel(swicth_point)+1
        ...
        switch T(ind1+1)
            ...
            case 0
                ...
                MJD   = juliandate(dtime);
                MJD_day = floor(MJD);
                MJD_seconds = (MJD-MJD_days)*3600*24;
                A = [MJD_day,MJD_seconds,xx*setup.lc/1000,yy*setup.lc/1000,zz*setup.lc/1000];
                
                dlmwrite(['EJPcoast',num2str(kk),'.txt'],A, 'precision', 15, 'delimiter','\t')
            ...
            case 1
                ...
                dlmwrite(['EJPthrust',num2str(kk),'.txt'],A, 'precision', 15, 'delimiter','\t')
