...
hpm = p_left(1)*1e6/setup.lc*1000;
cc  = p_left(2);
%
...
link = [xf_left(1:3)-x0_right(1:3); vxf-vf_out(1); vyf-vf_out(2);vzf-vf_out(3); tf-t0 ; m0-mf; p_left(end)-p_right(end); p_left(end-1)-p_right(end-1); p_left(end-2)-p_right(end-2) ];
