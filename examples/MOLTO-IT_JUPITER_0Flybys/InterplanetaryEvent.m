...
%if iphase==1
    ...
    rp0 = S0(1:3)*1e3/lc;
    theta = atan2(rp0(2),rp0(1));
    vinf = v_inf0*1e3/vc*[cos(alpha1)*cos(alpha2),cos(alpha1)*sin(alpha2),sin(alpha1)]';
    vinf(1) =vinf(1)*cos(theta) + vinf(2)*sin(theta);
    vinf(2) =-vinf(1)*sin(theta) + vinf(2)*cos(theta);
    vp0  = S0(4:6)*1e3/vc + vinf;
    ...
    event = [x0-rp0(1);y0-rp0(2);z0-rp0(3);vx0-vp0(1);vy0-vp0(2);vz0-vp0(3);xf-rpf(1);yf-rpf(2);zf-rpf(3)];
...
% 
% 
%     event = [event; xf-rpf(1);yf-rpf(2);zf-rpf(3)];
...
%else
 ...
 %   event = [xf-rpf(1);yf-rpf(2);zf-rpf(3)];
